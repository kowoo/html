...
create sequence comment_seq2 start with 1 increment by 1 maxvalue 99999 cycle; 
alter sequence board_seq2 increment by 1;
insert into board2 values (board_seq2.nextval,'첫번째 게시글','2','1번','첫번째 게시글 입니다.',0,sysdate);
