 ...
 * 총알
 */
function Hack(parent,posX,posY,width,height,enemies){
	...
	this.init = function(){
		...
		this.img = $("<img>").attr("src","./img/bullet.png").width(this.width +"px").height(this.heigth+"px");
	...
	this.move = function(){
		...
		if(this.posX>975) {
			this.span.css("left",975+"px");
		} else if (this.posX<10) {
			this.span.css("left",10+"px");
		}
